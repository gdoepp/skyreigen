...
public class CAAElliptical {
    ...
    public static CAAEllipticalPlanetaryDetails Calculate(double JD, CAAElliptical.EllipticalObject object) {
        return new CAAEllipticalPlanetaryDetails(AAJNI.CAAElliptical_Calculate__SWIG_0(JD, object.swigValue()), true);
    }
    ...
    public static CAAEllipticalObjectDetails Calculate(double JD, CAAEllipticalObjectElements elements) {
        return new CAAEllipticalObjectDetails(AAJNI.CAAElliptical_Calculate__SWIG_1(JD, CAAEllipticalObjectElements.getCPtr(elements), elements), true);
    }
