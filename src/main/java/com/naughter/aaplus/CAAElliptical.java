...
public class CAAElliptical {
  ...
  public static CAAEllipticalObjectDetails Calculate(double JD, CAAEllipticalObjectElements elements, boolean bHighPrecision, double epsilon) {
    return new CAAEllipticalObjectDetails(AAJNI.CAAElliptical_Calculate__SWIG_1(JD, CAAEllipticalObjectElements.getCPtr(elements), elements, bHighPrecision, epsilon), true);
  }

  public static CAAEllipticalObjectDetails Calculate(double JD, CAAEllipticalObjectElements elements, boolean bHighPrecision) {
    return new CAAEllipticalObjectDetails(AAJNI.CAAElliptical_Calculate__SWIG_2(JD, CAAEllipticalObjectElements.getCPtr(elements), elements, bHighPrecision), true);
  }
