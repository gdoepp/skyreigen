...
public class CAAInterpolate {
  ...
  protected static long swigRelease(CAAInterpolate obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public static double Extremum(double Y1, double Y2, double Y3, double Y4, double Y5, SWIGTYPE_p_double nm, double epsilon) {
    return AAJNI.CAAInterpolate_Extremum__SWIG_1(Y1, Y2, Y3, Y4, Y5, SWIGTYPE_p_double.getCPtr(nm), epsilon);
  }

  public static double Extremum(double Y1, double Y2, double Y3, double Y4, double Y5, SWIGTYPE_p_double nm) {
    return AAJNI.CAAInterpolate_Extremum__SWIG_2(Y1, Y2, Y3, Y4, Y5, SWIGTYPE_p_double.getCPtr(nm));
  }

  public static double Zero(double Y1, double Y2, double Y3, double epsilon) {
    return AAJNI.CAAInterpolate_Zero__SWIG_0(Y1, Y2, Y3, epsilon);
  }

  public static double Zero(double Y1, double Y2, double Y3) {
    return AAJNI.CAAInterpolate_Zero__SWIG_1(Y1, Y2, Y3);
  }

  public static double Zero(double Y1, double Y2, double Y3, double Y4, double Y5, double epsilon) {
    return AAJNI.CAAInterpolate_Zero__SWIG_2(Y1, Y2, Y3, Y4, Y5, epsilon);
  }

  public static double Zero(double Y1, double Y2, double Y3, double Y4, double Y5) {
    return AAJNI.CAAInterpolate_Zero__SWIG_3(Y1, Y2, Y3, Y4, Y5);
  }

  public static double Zero2(double Y1, double Y2, double Y3, double epsilon) {
    return AAJNI.CAAInterpolate_Zero2__SWIG_0(Y1, Y2, Y3, epsilon);
  }

  public static double Zero2(double Y1, double Y2, double Y3) {
    return AAJNI.CAAInterpolate_Zero2__SWIG_1(Y1, Y2, Y3);
  }

  public static double Zero2(double Y1, double Y2, double Y3, double Y4, double Y5, double epsilon) {
    return AAJNI.CAAInterpolate_Zero2__SWIG_2(Y1, Y2, Y3, Y4, Y5, epsilon);
  }

  public static double Zero2(double Y1, double Y2, double Y3, double Y4, double Y5) {
    return AAJNI.CAAInterpolate_Zero2__SWIG_3(Y1, Y2, Y3, Y4, Y5);
  }
