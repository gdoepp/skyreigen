...
public class CAANearParabolic {
  ...
  protected static long swigRelease(CAANearParabolic obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public static void CalculateTrueAnomalyAndRadius(double JD, CAANearParabolicObjectElements elements, SWIGTYPE_p_double v, SWIGTYPE_p_double r) {
    AAJNI.CAANearParabolic_CalculateTrueAnomalyAndRadius(JD, CAANearParabolicObjectElements.getCPtr(elements), elements, SWIGTYPE_p_double.getCPtr(v), SWIGTYPE_p_double.getCPtr(r));
  }
