...
public class CAANearParabolicObjectDetails {
  ...
  protected static long swigRelease(CAANearParabolicObjectDetails obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void setR(double value) {
    AAJNI.CAANearParabolicObjectDetails_r_set(swigCPtr, this, value);
  }

  public double getR() {
    return AAJNI.CAANearParabolicObjectDetails_r_get(swigCPtr, this);
  }

  public void setV(double value) {
    AAJNI.CAANearParabolicObjectDetails_v_set(swigCPtr, this, value);
  }

  public double getV() {
    return AAJNI.CAANearParabolicObjectDetails_v_get(swigCPtr, this);
  }
