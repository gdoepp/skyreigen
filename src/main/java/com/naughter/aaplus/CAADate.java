...
public class CAADate {
  ...
  public void Set(double JD, boolean bGregorianCalendar) {
    AAJNI.CAADate_Set__SWIG_0(swigCPtr, this, JD, bGregorianCalendar);
  }

  public void Set(int Year, int Month, double Day, double Hour, double Minute, double Second, boolean bGregorianCalendar) {
    AAJNI.CAADate_Set__SWIG_1(swigCPtr, this, Year, Month, Day, Hour, Minute, Second, bGregorianCalendar);
  }

  public boolean IsValid() {
    return AAJNI.CAADate_IsValid(swigCPtr, this);
  }

  public void SetInvalid() {
    AAJNI.CAADate_SetInvalid(swigCPtr, this);
  }
  ...
  public CAADate(CAADate arg0) {
    this(AAJNI.new_CAADate__SWIG_4(CAADate.getCPtr(arg0), arg0), true);
  }
  ...
  public static int DaysInCommonMonth(int Month) {
    return AAJNI.CAADate_DaysInCommonMonth(Month);
  }
  ...
  public final static double UNIX_EPOCH_AS_JD = AAJNI.CAADate_UNIX_EPOCH_AS_JD_get();
