...
public class CAAParabolicObjectDetails {
  ...
  protected static long swigRelease(CAAParabolicObjectDetails obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void setR(double value) {
    AAJNI.CAAParabolicObjectDetails_r_set(swigCPtr, this, value);
  }

  public double getR() {
    return AAJNI.CAAParabolicObjectDetails_r_get(swigCPtr, this);
  }

  public void setV(double value) {
    AAJNI.CAAParabolicObjectDetails_v_set(swigCPtr, this, value);
  }

  public double getV() {
    return AAJNI.CAAParabolicObjectDetails_v_get(swigCPtr, this);
  }
  ...
  public void setAstrometricGeocentricRA(double value) {
    AAJNI.CAAParabolicObjectDetails_AstrometricGeocentricRA_set(swigCPtr, this, value);
  }

  public double getAstrometricGeocentricRA() {
    return AAJNI.CAAParabolicObjectDetails_AstrometricGeocentricRA_get(swigCPtr, this);
  }
